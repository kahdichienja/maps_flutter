...
const kGoogleApiKey = "AIzaSyBdR4yt-I9tsrM6Z_bC1EF4GfHiiyXMkzI";
...
class PlaceDetailState extends State<PlaceDetailWidget> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    var markerOptions = Marker(
        position: center,
        infoWindow: InfoWindow(title: "${placeDetail.name} ${placeDetail.formattedAddress}"));
    // mapController.addMarkers(markerOptions);
