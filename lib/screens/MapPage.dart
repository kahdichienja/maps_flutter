...
import 'package:flutter_maps/Provider/MapProvider.dart';
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            // Map View
            GoogleMap(
              markers: mapState.markers != null ? Set<Marker>.from(mapState.markers) : null,
                    ...
                    children: <Widget>[
                      ...
                      _textField(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () {
                              mapState.startAddressController.text = mapState.currentAddress;
                      ...
                      RaisedButton(
                        onPressed: (mapState.startAddress != '' &&
                            ...
                            ? () async {
                                setState(() {
                                  if (mapState.markers.isNotEmpty) mapState.markers.clear();
                                ...
                                mapState.calculateDistance().then((isCalculated) {
                                  if (isCalculated) {
                                    mapState.scaffoldKey.currentState.showSnackBar(
                                      SnackBar(
